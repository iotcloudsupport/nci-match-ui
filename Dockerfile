...
#CMD ls /usr/local/apache2/match/ && ls /usr/local/apache2/match/app/scripts/env/ && /usr/local/apache2/match/setenv.sh && httpd-foreground -C 'DocumentRoot /usr/local/apache2/match/app/'
