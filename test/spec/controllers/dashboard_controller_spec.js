describe('Controller: dashboard Controller', function () {
    ...
    it('should populate the dashboard Patient Pending Assignment list with  on a success response', function() {
        ...
        expect(scope.pendingAssignmentReportList.length).toBe(3);
        expect(scope.pendingAssignmentReportList[0].patientSequenceNumber).toBe('10375');
        expect(scope.pendingAssignmentReportList[1].biopsySequenceNumber).toBe('N-15-00006');
        expect(scope.pendingAssignmentReportList[2].jobName).toBe('testjob8');
    });
