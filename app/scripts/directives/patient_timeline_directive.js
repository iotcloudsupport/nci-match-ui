    ...
    function patientTimeline($compile, $http, $templateCache, $log) {
        ...
        */
        ...
        var templateMap = {
            ...
            'biopsy.variantReportReceived.normal': baseUrl + 'biopsy_variantReportReceived.html',
            'biopsy.variantReportReceived.narrow': baseUrl + 'biopsy_variantReportReceived_narrow.html',
            'biopsy.variantReportShipped.normal': baseUrl + 'biopsy_variantReportShipped.html',
            'biopsy.variantReportShipped.narrow': baseUrl + 'biopsy_variantReportShipped_narrow.html',
